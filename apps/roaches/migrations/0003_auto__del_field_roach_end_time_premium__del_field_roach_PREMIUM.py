...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Roach.end_time_premium'
        db.delete_column('roaches_roach', 'end_time_premium')

        # Deleting field 'Roach.PREMIUM'
        db.delete_column('roaches_roach', 'PREMIUM')

    def backwards(self, orm):
        # Adding field 'Roach.end_time_premium'
        db.add_column('roaches_roach', 'end_time_premium',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 6, 14, 15, 13, 56, 239242), blank=True),
                      keep_default=False)

        # Adding field 'Roach.PREMIUM'
        db.add_column('roaches_roach', 'PREMIUM',
