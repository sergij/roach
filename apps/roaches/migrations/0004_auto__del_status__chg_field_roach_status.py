...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Roach.status' to match new field type.
        db.rename_column('roaches_roach', 'status_id', 'status')
        # Changing field 'Roach.status'
        db.alter_column('roaches_roach', 'status', self.gf('django.db.models.fields.IntegerField')())
    def backwards(self, orm):
        ...
        # Renaming column for 'Roach.status' to match new field type.
        db.rename_column('roaches_roach', 'status', 'status_id')
        # Changing field 'Roach.status'
        db.alter_column('roaches_roach', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roaches.Status']))
    models = {
        'auth.group': {
